...
function GeneratorValue(props) {
    const handleClick = () => props.setCurrent(props.value);
...
export default function Generate(props) {
    ...
    return (<main className="container">
            ...
            <Alert variant={"info"}>Since you can generate other generators as values, there can be an infinite number of generated values which obviously can&apos;t be displayed here. If a generator generates another generator a link will be provided to the values generated by the resulting generators.</Alert>
