...
export default function AboutPage() {
    return (<main className="container">
        ...
        <p>There are two ways to create generators: You can import previously exported generators, and you can use the <a>create generator page</a>. From there you can currently either create a "table generator" or an "entity generator".</p>

        <h4>Table Generator</h4>

        <p>A table generator is a generator that you define by giving it a table of values, and when you run it, it will randomly generate one of those values. Those values can be regular words or numbers like names or they can be other generators. If the table generator generates another generator you can then go to the value that, that generator creates. Say you have a table of types of tools that you want to pick from randomly, you might want each of the entries in the table to be generators which give a particular tool of that type. For example an entry in a table of types of tools that might come up might be saws, and if that generator came up it might generate a value like a jigsaw, or a bandsaw. This can be useful, but it is more useful in conjunction with the entity generator.</p>
        ...
        <p>To actually run and get the values the generators generate, you can go to the home page, and select the generator you want to run out of your list of generators. On that page you can edit that generator, but there's also a field to enter a "seed" and run it. Once you enter a seed you can run the generator.</p>
        ...
        <p>When you run the generator you should be taken to a page with the values of the value generated by the generator. It will show the "top level" values related to that generator, but won't show the values generated by other generators which may be related to whatever the initial generator generated (other than table values in some cases, but that was just for convenience). This is because the generators related to the result of another generator can create an infinite chain of generators and values, and the web app isn't able to display infinitely many values at once (I'd be impressed if any web app could). The page for the values will have a link to the values of any generator related to the current value which you can follow and see the value generated by that generator. You can follow the chain of values and generators for as many values as you want. You can go back to the value that generated the current value by selecting the link to go back to the "parent".</p>
